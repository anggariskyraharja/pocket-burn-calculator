...
export class Tab1Page {
  ...
  calculate(){
    if (this.height == null || this.weight == null || this.time == null || this.fluid == null || this.burn == null || 
      ...
      this.note1 = 'The fluid requirements are ' + this.roundoff(parkland) + ' mL. (4 mL x kg body weight x % burn area)'
      ...
      if (this.child == false){
          this.note7 = 'Target urine output is 0.5 - 1.0 mL/kg body weight/hour.'
          ...
          this.note7 = 'Target urine output is 1.0 - 2.0 mL/kg body weight/hour.'
          if (this.weightx > 20){
